...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("nftmart"),
	impl_name: create_runtime_str!("nftmart"),
...
impl pallet_staking::Config for Runtime {
	...
	// type ElectionProvider = onchain::OnChainSequentialPhragmen<pallet_election_provider_multi_phase::OnChainConfig<Self>>;
...
impl pallet_contracts::Config for Runtime {
	...
	type ChainExtension = chain_extension::NftmartExtension<Self>;
